...
modules:
 ...
 -  name: camera_reader
    ...
    \label{sec:crap:communication}
        ...
        \lstset{caption={Excerpts from the mode-switching code in the state-machine, demonstating the use of internal messaging.},label=lst:crap:communication:internal}
        \begin{minipage}{\textwidth}
        \begin{lstlisting}
