            ...
            \begin{figure}[H]
                \noindent\makebox[\textwidth]{
                    \begin{tikzpicture}[auto]
                        ...
                        \node[action, right of=calccontrol, node distance=2.5cm] (refup) {Update reference};
                        \node [event, above of=refup, node distance=1.5cm] (reference) {New reference};
...
extern "C" {
    ...
    void* hover() {
        ...
        \subsection{Camera Reader, Sensor Reader and Baselink}
            ...
            The baselink module interfaces the graphical front-end, presented in Section~\ref{sec:crap:interface},
