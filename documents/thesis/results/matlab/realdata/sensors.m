skip = floor(length(measurements.imu.time)*skipsec);
%% Accelerometers
...
subplot(3,1,3); fit_to_normal(measurements.imu.accZ(1:end-skip) - simulation.imu.accZ(1:end-skip)); title('Z'); xlabel('m/s^2');
