...
\label{sec:results:control}
    ...
    \fig{1}{referencefollowing}{Control of the simulated flight was stable, although - being untuned - somewhat slow. The actuation of the yaw rate is very weak, which is evident in slow reaction of the yaw rate control.}{fig:results:control:referencefollowing}
