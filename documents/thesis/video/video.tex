...
\pagebreak
    \section{The PTAM Library}
        ...
        \subsection{Operation}
            ...
            \fig{\imagewidth}{ptamtracking}{Features - visualized as dots - are projected into the image and sought for. The calculated offset from the positions where the features were first detected then yield a position estimate.}{fig:video:ptamtracking}
